...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "StockFlow — Warehouse Management" },
      { name: "description", content: "Fast, professional warehouse management: inventory, sales, purchases, cash and profit tracking." },
      { property: "og:title", content: "StockFlow — Warehouse Management" },
      { property: "og:description", content: "Fast, professional warehouse management: inventory, sales, purchases, cash and profit tracking." },
